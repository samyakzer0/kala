...
export default function SpotlightRing() {
  return (
    <section id="spotlight-ring" className="bg-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div className="relative aspect-square max-w-md mx-auto mb-12 rounded-full overflow-hidden bg-white shadow-2xl">
          <img 
        ...
        <button className="bg-black text-white px-12 py-4 rounded-full text-lg font-medium hover:bg-gray-800 transition-colors whitespace-nowrap cursor-pointer">
          Get Yours
        </button>
      </div>
    </section>
